			...
			<div class="col-md-4 col-sm-12 col-xs-12 col-md-offset-4">
				<form class="frm_student_sign">
					...
					<div class="form-group">
						...
						<input type="tel" name="s_contact" class="form-control" required autocomplete="off" maxlength="11">
					</div>
					<div class="form-group">
				...
				<form class="frm_faculty_sign hide">
					...
					<div class="form-group">
						<label>Contact Number</label>
						<input type="tel" name="f_contact" class="form-control" required autocomplete="off" maxlength="11">
					</div>
					<div class="form-group">
						<label>Department</label>
